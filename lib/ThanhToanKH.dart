...
const String appName = 'Thanh Toán';

class ThanhToanKH extends StatelessWidget {
  @override
                  ...
                  child: Builder(
                    builder: (context) {
                      return _inProgress
                        ...
                        children: <Widget>[
                          _getPlatformButton(
                              'Thẻ Thanh Toán', () => _startAfreshCharge()),
                          _verticalSizeBox,
                          _border,
                          new SizedBox(
                            height: 40.0,
...
var banks = ['Chọn phương thức', 'Ngân Hàng', 'Thẻ'];
